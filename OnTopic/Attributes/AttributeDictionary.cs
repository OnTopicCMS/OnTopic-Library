...
namespace OnTopic.Attributes {
  ...
  ///   model that has a primary constructor accepting a single <see cref="AttributeDictionary"/> will be initialized using
  ///   a <see cref="AttributeDictionary"/> containing all attributes from not only the current <see cref="Topic"/>, but also
  ///   any <see cref="Topic.BaseTopic"/>s it references.
  /// </remarks>
