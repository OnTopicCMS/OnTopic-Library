...
TABLE	[dbo].[topics_Relationships] (
  ...
  CONSTRAINT	  [FK_Relationships_Source]	FOREIGN KEY	([Source_TopicID]) REFERENCES [dbo].[topics_Topics] ([TopicID]),
  CONSTRAINT	  [FK_Relationships_Target]	FOREIGN KEY	([Target_TopicID]) REFERENCES [dbo].[topics_Topics] ([TopicID])
);
