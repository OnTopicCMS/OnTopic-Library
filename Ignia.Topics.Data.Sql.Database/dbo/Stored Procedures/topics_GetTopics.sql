...
--	Katherine Trunkey	08072014	Added ROW_NUMBER functionality to (indexed) Attributes selection and TOP 1
--				selection to Blob to support versioning of Topic Attributes.
...
--	Jeremy Caney		07252017	Removed support for depth and versioning; versions should be loaded via new
--				loadVersion sproc
-----------------------------------------------------------------------------------------------------------------------------------------------
