...
namespace OnTopic.Web.Configuration {
  ...
  /// </summary>
  /// <remarks>
  ///   Includes the Default property that exposes the default page type (<see cref="OnTopic.Web.TopicPage"/>).
  /// </remarks>
  public class PageTypeElementCollection : ConfigurationElementCollection {
    ...
    \-------------------------------------------------------------------------------------------------------------------------*/
    /// <summary>
    ///   Gets the default page type (e.g., <see cref="OnTopic.Web.TopicPage"/>).
    /// </summary>
