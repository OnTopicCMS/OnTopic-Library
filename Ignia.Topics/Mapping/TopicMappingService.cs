...
namespace Ignia.Topics.Mapping {
  ...
  public class TopicMappingService : ITopicMappingService {
    ...
    protected async Task SetPropertyAsync(
      ...
      //Attempt to provide a 1:1 mapping, if applicable
      else {
        SetCompatibleProperty(source, target, configuration);
      }
    ...
    /// <param name="configuration">The <see cref="PropertyConfiguration"/> with details about the property's attributes.</param>
    /// <autogeneratedoc />
    protected static void SetCompatibleProperty(Topic source, object target, PropertyConfiguration configuration) {
