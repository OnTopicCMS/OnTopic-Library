...
namespace Ignia.Topics.Mapping {
  ...
  public sealed class MapToTypeAttribute : System.Attribute {
    ...
    /// </summary>
    public MapToTypeAttribute(Type type = null) {
      this.Type = type;
    }
    ...
    \-------------------------------------------------------------------------------------------------------------------------*/
    /// <summary>
    ///   Gets or sets the type that source <see cref="Topic"/> instances should be mapped to.
    /// </summary>
